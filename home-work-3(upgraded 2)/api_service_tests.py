...
@pytest.mark.parametrize('title', get_random_pairs(['Qwerty','123']))
@pytest.mark.parametrize('author', get_random_pairs(['Puskin',]))
...
def test_get_filtered_list_of_books():
    """ Check that 'get books' method returns correct list of books. """
